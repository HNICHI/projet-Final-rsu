      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <router-link to="/Table_Nomenclatures">
            <img src="https://img.icons8.com/nolan/64/child-safe-zone.png" />
            Tables Nomenclatures
          </router-link>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Qualités</li>
      </ol>
    </nav>
      ...
      <div class="table-crud-body row">
        <table class="table table-hover col-md-6 m-auto">
          ...
          <tbody class="crud-body">
            <tr :key="qualite.id_qualite" v-for="qualite in allQualites">
...
export default {
  ...
  methods: {
    // spread operator
    ...mapActions(["getQualites"]),
    submit(e) {
      e.preventDefault;
      console.log("sending");
      this.$store.dispatch("addQualites", this.qualite);
      this.qualite = "";
    },
  },
  computed: {
    ...mapGetters(["allQualites"]),
  },
